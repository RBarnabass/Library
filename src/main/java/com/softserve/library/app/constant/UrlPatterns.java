package com.softserve.library.app.constant;
...
public class UrlPatterns {
    ...
    // LIBRARIAN
    public static final String BOOK_OPTION = "/library/book_option";
    public static final String BOOK_STATISTIC = "/library/book_statistic";
