...
public interface BookDao extends SimpleCrudDao<Book> {
    ...
    List<Book> getAllByBookNameAndPublisherAndYearPeriodAndAuthor(String bookName, String publisher, int start, int end, String author) throws SQLException;
    ...
    int addBookAndGetIdBack(Book book) throws SQLException;
}
